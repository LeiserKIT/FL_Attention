...
class ChestXRays(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.train == True:
            ...
            rcrop = transforms.RandomCrop(int(0.875*image.size[1]))
            image = rcrop(image)
...
def load_data(sim, sc, num_samples, bs):
    ...
    # sim0
    if sim == 0:
        train_dataset_0 = ChestXRays(csv_file="../data/train/FL/sim0/train/df_train_0.csv", root_dir="../data/CheXpert/", train=True, scale_percent=sc, num_samples=num_samples)
        trainloader_0 = torch.utils.data.DataLoader(train_dataset_0, batch_size=bs, shuffle=True, num_workers=8, worker_init_fn=_worker_init_fn_)
        valid_dataset_0 = ChestXRays(csv_file="../data/train/FL/sim0/valid/df_valid_0.csv", root_dir="../data/CheXpert/", train=False, scale_percent=sc, num_samples=num_samples)
        validloader_0 = torch.utils.data.DataLoader(valid_dataset_0, batch_size=bs, shuffle=False, num_workers=8)
        train_dataset_1 = ChestXRays(csv_file="../data/train/FL/sim0/train/df_train_1.csv", root_dir="../data/CheXpert/", train=True, scale_percent=sc, num_samples=num_samples)
        trainloader_1 = torch.utils.data.DataLoader(train_dataset_1, batch_size=bs, shuffle=True, num_workers=8, worker_init_fn=_worker_init_fn_)
        valid_dataset_1 = ChestXRays(csv_file="../data/train/FL/sim0/valid/df_valid_1.csv", root_dir="../data/CheXpert/", train=False, scale_percent=sc, num_samples=num_samples)
        validloader_1 = torch.utils.data.DataLoader(valid_dataset_1, batch_size=bs, shuffle=False, num_workers=8)
        train_dataset_2 = ChestXRays(csv_file="../data/train/FL/sim0/train/df_train_2.csv", root_dir="../data/CheXpert/", train=True, scale_percent=sc, num_samples=num_samples)
        trainloader_2 = torch.utils.data.DataLoader(train_dataset_2, batch_size=bs, shuffle=True, num_workers=8, worker_init_fn=_worker_init_fn_)
        valid_dataset_2 = ChestXRays(csv_file="../data/train/FL/sim0/valid/df_valid_2.csv", root_dir="../data/CheXpert/", train=False, scale_percent=sc, num_samples=num_samples)
        validloader_2 = torch.utils.data.DataLoader(valid_dataset_2, batch_size=bs, shuffle=False, num_workers=8)
        train_dataset_3 = ChestXRays(csv_file="../data/train/FL/sim0/train/df_train_3.csv", root_dir="../data/CheXpert/", train=True, scale_percent=sc, num_samples=num_samples)
        trainloader_3 = torch.utils.data.DataLoader(train_dataset_3, batch_size=bs, shuffle=True, num_workers=8, worker_init_fn=_worker_init_fn_)
        valid_dataset_3 = ChestXRays(csv_file="../data/train/FL/sim0/valid/df_valid_3.csv", root_dir="../data/CheXpert/", train=False, scale_percent=sc, num_samples=num_samples)
        validloader_3 = torch.utils.data.DataLoader(valid_dataset_3, batch_size=bs, shuffle=False, num_workers=8)
        train_dataset_4 = ChestXRays(csv_file="../data/train/FL/sim0/train/df_train_4.csv", root_dir="../data/CheXpert/", train=True, scale_percent=sc, num_samples=num_samples)
        trainloader_4 = torch.utils.data.DataLoader(train_dataset_4, batch_size=bs, shuffle=True, num_workers=8, worker_init_fn=_worker_init_fn_)
        valid_dataset_4 = ChestXRays(csv_file="../data/train/FL/sim0/valid/df_valid_4.csv", root_dir="../data/CheXpert/", train=False, scale_percent=sc, num_samples=num_samples)
        validloader_4 = torch.utils.data.DataLoader(valid_dataset_4, batch_size=bs, shuffle=False, num_workers=8)
        ...
        train_datasets = [train_dataset_0, train_dataset_1, train_dataset_2, train_dataset_3, train_dataset_4]
        trainloaders = [trainloader_0, trainloader_1, trainloader_2, trainloader_3, trainloader_4]
        validloaders = [validloader_0, validloader_1, validloader_2, validloader_3, validloader_4]

    # sim1
    if sim == 1:
        train_dataset_0 = ChestXRays(csv_file="../data/train/FL/sim1/train/df_train_0.csv", root_dir="../data/CheXpert/", train=True, scale_percent=sc, num_samples=num_samples)
        trainloader_0 = torch.utils.data.DataLoader(train_dataset_0, batch_size=bs, shuffle=True, num_workers=8, worker_init_fn=_worker_init_fn_)
        valid_dataset_0 = ChestXRays(csv_file="../data/train/FL/sim1/valid/df_valid_0.csv", root_dir="../data/CheXpert/", train=False, scale_percent=sc, num_samples=num_samples)
        validloader_0 = torch.utils.data.DataLoader(valid_dataset_0, batch_size=bs, shuffle=False, num_workers=8)
        train_dataset_1 = ChestXRays(csv_file="../data/train/FL/sim1/train/df_train_1.csv", root_dir="../data/CheXpert/", train=True, scale_percent=sc, num_samples=num_samples)
        trainloader_1 = torch.utils.data.DataLoader(train_dataset_1, batch_size=bs, shuffle=True, num_workers=8, worker_init_fn=_worker_init_fn_)
        valid_dataset_1 = ChestXRays(csv_file="../data/train/FL/sim1/valid/df_valid_1.csv", root_dir="../data/CheXpert/", train=False, scale_percent=sc, num_samples=num_samples)
        validloader_1 = torch.utils.data.DataLoader(valid_dataset_1, batch_size=bs, shuffle=False, num_workers=8)
        train_dataset_2 = ChestXRays(csv_file="../data/train/FL/sim1/train/df_train_2.csv", root_dir="../data/CheXpert/", train=True, scale_percent=sc, num_samples=num_samples)
        trainloader_2 = torch.utils.data.DataLoader(train_dataset_2, batch_size=bs, shuffle=True, num_workers=8, worker_init_fn=_worker_init_fn_)
        valid_dataset_2 = ChestXRays(csv_file="../data/train/FL/sim1/valid/df_valid_2.csv", root_dir="../data/CheXpert/", train=False, scale_percent=sc, num_samples=num_samples)
        validloader_2 = torch.utils.data.DataLoader(valid_dataset_2, batch_size=bs, shuffle=False, num_workers=8)
        train_dataset_3 = ChestXRays(csv_file="../data/train/FL/sim1/train/df_train_3.csv", root_dir="../data/CheXpert/", train=True, scale_percent=sc, num_samples=num_samples)
        trainloader_3 = torch.utils.data.DataLoader(train_dataset_3, batch_size=bs, shuffle=True, num_workers=8, worker_init_fn=_worker_init_fn_)
        valid_dataset_3 = ChestXRays(csv_file="../data/train/FL/sim1/valid/df_valid_3.csv", root_dir="../data/CheXpert/", train=False, scale_percent=sc, num_samples=num_samples)
        validloader_3 = torch.utils.data.DataLoader(valid_dataset_3, batch_size=bs, shuffle=False, num_workers=8)
        train_dataset_4 = ChestXRays(csv_file="../data/train/FL/sim1/train/df_train_4.csv", root_dir="../data/CheXpert/", train=True, scale_percent=sc, num_samples=num_samples)
        trainloader_4 = torch.utils.data.DataLoader(train_dataset_4, batch_size=bs, shuffle=True, num_workers=8, worker_init_fn=_worker_init_fn_)
        valid_dataset_4 = ChestXRays(csv_file="../data/train/FL/sim1/valid/df_valid_4.csv", root_dir="../data/CheXpert/", train=False, scale_percent=sc, num_samples=num_samples)
        validloader_4 = torch.utils.data.DataLoader(valid_dataset_4, batch_size=bs, shuffle=False, num_workers=8)
        test_dataset = ChestXRays(csv_file="../data/test/df_test.csv", root_dir="../data/CheXpert/", train=False, scale_percent=sc, num_samples=num_samples)
        testloader = torch.utils.data.DataLoader(test_dataset, batch_size=bs, shuffle=False, num_workers=8)
    ...
    # sim2
    if sim == 2:
        train_dataset_0 = ChestXRays(csv_file="../data/train/FL/sim2/train/df_train_0.csv", root_dir="../data/CheXpert/", train=True, scale_percent=sc, num_samples=num_samples)
        trainloader_0 = torch.utils.data.DataLoader(train_dataset_0, batch_size=bs, shuffle=True, num_workers=8, worker_init_fn=_worker_init_fn_)
        valid_dataset_0 = ChestXRays(csv_file="../data/train/FL/sim2/valid/df_valid_0.csv", root_dir="../data/CheXpert/", train=False, scale_percent=sc, num_samples=num_samples)
        validloader_0 = torch.utils.data.DataLoader(valid_dataset_0, batch_size=bs, shuffle=False, num_workers=8)
        train_dataset_1 = ChestXRays(csv_file="../data/train/FL/sim2/train/df_train_1.csv", root_dir="../data/CheXpert/", train=True, scale_percent=sc, num_samples=num_samples)
        trainloader_1 = torch.utils.data.DataLoader(train_dataset_1, batch_size=bs, shuffle=True, num_workers=8, worker_init_fn=_worker_init_fn_)
        valid_dataset_1 = ChestXRays(csv_file="../data/train/FL/sim2/valid/df_valid_1.csv", root_dir="../data/CheXpert/", train=False, scale_percent=sc, num_samples=num_samples)
        validloader_1 = torch.utils.data.DataLoader(valid_dataset_1, batch_size=bs, shuffle=False, num_workers=8)
        train_dataset_2 = ChestXRays(csv_file="../data/train/FL/sim2/train/df_train_2.csv", root_dir="../data/CheXpert/", train=True, scale_percent=sc, num_samples=num_samples)
        trainloader_2 = torch.utils.data.DataLoader(train_dataset_2, batch_size=bs, shuffle=True, num_workers=8, worker_init_fn=_worker_init_fn_)
        valid_dataset_2 = ChestXRays(csv_file="../data/train/FL/sim2/valid/df_valid_2.csv", root_dir="../data/CheXpert/", train=False, scale_percent=sc, num_samples=num_samples)
        validloader_2 = torch.utils.data.DataLoader(valid_dataset_2, batch_size=bs, shuffle=False, num_workers=8)
        train_dataset_3 = ChestXRays(csv_file="../data/train/FL/sim2/train/df_train_3.csv", root_dir="../data/CheXpert/", train=True, scale_percent=sc, num_samples=num_samples)
        trainloader_3 = torch.utils.data.DataLoader(train_dataset_3, batch_size=bs, shuffle=True, num_workers=8, worker_init_fn=_worker_init_fn_)
        valid_dataset_3 = ChestXRays(csv_file="../data/train/FL/sim2/valid/df_valid_3.csv", root_dir="../data/CheXpert/", train=False, scale_percent=sc, num_samples=num_samples)
        validloader_3 = torch.utils.data.DataLoader(valid_dataset_3, batch_size=bs, shuffle=False, num_workers=8)
        train_dataset_4 = ChestXRays(csv_file="../data/train/FL/sim2/train/df_train_4.csv", root_dir="../data/CheXpert/", train=True, scale_percent=sc, num_samples=num_samples)
        trainloader_4 = torch.utils.data.DataLoader(train_dataset_4, batch_size=bs, shuffle=True, num_workers=8, worker_init_fn=_worker_init_fn_)
        valid_dataset_4 = ChestXRays(csv_file="../data/train/FL/sim2/valid/df_valid_4.csv", root_dir="../data/CheXpert/", train=False, scale_percent=sc, num_samples=num_samples)
        validloader_4 = torch.utils.data.DataLoader(valid_dataset_4, batch_size=bs, shuffle=False, num_workers=8)
        test_dataset = ChestXRays(csv_file="../data/test/df_test.csv", root_dir="../data/CheXpert/", train=False, scale_percent=sc, num_samples=num_samples)
        testloader = torch.utils.data.DataLoader(test_dataset, batch_size=bs, shuffle=False, num_workers=8)
    ...
    # sim3
    if sim == 3:
        train_dataset_0 = ChestXRays(csv_file="../data/train/FL/sim3/train/df_train_0.csv", root_dir="../data/CheXpert/", train=True, scale_percent=sc, num_samples=num_samples)
        trainloader_0 = torch.utils.data.DataLoader(train_dataset_0, batch_size=bs, shuffle=True, num_workers=8, worker_init_fn=_worker_init_fn_)
        valid_dataset_0 = ChestXRays(csv_file="../data/train/FL/sim3/valid/df_valid_0.csv", root_dir="../data/CheXpert/", train=False, scale_percent=sc, num_samples=num_samples)
        validloader_0 = torch.utils.data.DataLoader(valid_dataset_0, batch_size=bs, shuffle=False, num_workers=8)
        train_dataset_1 = ChestXRays(csv_file="../data/train/FL/sim3/train/df_train_1.csv", root_dir="../data/CheXpert/", train=True, scale_percent=sc, num_samples=num_samples)
        trainloader_1 = torch.utils.data.DataLoader(train_dataset_1, batch_size=bs, shuffle=True, num_workers=8, worker_init_fn=_worker_init_fn_)
        valid_dataset_1 = ChestXRays(csv_file="../data/train/FL/sim3/valid/df_valid_1.csv", root_dir="../data/CheXpert/", train=False, scale_percent=sc, num_samples=num_samples)
        validloader_1 = torch.utils.data.DataLoader(valid_dataset_1, batch_size=bs, shuffle=False, num_workers=8)
        train_dataset_2 = ChestXRays(csv_file="../data/train/FL/sim3/train/df_train_2.csv", root_dir="../data/CheXpert/", train=True, scale_percent=sc, num_samples=num_samples)
        trainloader_2 = torch.utils.data.DataLoader(train_dataset_2, batch_size=bs, shuffle=True, num_workers=8, worker_init_fn=_worker_init_fn_)
        valid_dataset_2 = ChestXRays(csv_file="../data/train/FL/sim3/valid/df_valid_2.csv", root_dir="../data/CheXpert/", train=False, scale_percent=sc, num_samples=num_samples)
        validloader_2 = torch.utils.data.DataLoader(valid_dataset_2, batch_size=bs, shuffle=False, num_workers=8)
        train_dataset_3 = ChestXRays(csv_file="../data/train/FL/sim3/train/df_train_3.csv", root_dir="../data/CheXpert/", train=True, scale_percent=sc, num_samples=num_samples)
        trainloader_3 = torch.utils.data.DataLoader(train_dataset_3, batch_size=bs, shuffle=True, num_workers=8, worker_init_fn=_worker_init_fn_)
        valid_dataset_3 = ChestXRays(csv_file="../data/train/FL/sim3/valid/df_valid_3.csv", root_dir="../data/CheXpert/", train=False, scale_percent=sc, num_samples=num_samples)
        validloader_3 = torch.utils.data.DataLoader(valid_dataset_3, batch_size=bs, shuffle=False, num_workers=8)
        train_dataset_4 = ChestXRays(csv_file="../data/train/FL/sim3/train/df_train_4.csv", root_dir="../data/CheXpert/", train=True, scale_percent=sc, num_samples=num_samples)
        trainloader_4 = torch.utils.data.DataLoader(train_dataset_4, batch_size=bs, shuffle=True, num_workers=8, worker_init_fn=_worker_init_fn_)
        valid_dataset_4 = ChestXRays(csv_file="../data/train/FL/sim3/valid/df_valid_4.csv", root_dir="../data/CheXpert/", train=False, scale_percent=sc, num_samples=num_samples)
        validloader_4 = torch.utils.data.DataLoader(valid_dataset_4, batch_size=bs, shuffle=False, num_workers=8)
        train_dataset_5 = ChestXRays(csv_file="../data/train/FL/sim3/train/df_train_5.csv", root_dir="../data/CheXpert/", train=True, scale_percent=sc, num_samples=num_samples)
        trainloader_5 = torch.utils.data.DataLoader(train_dataset_5, batch_size=bs, shuffle=True, num_workers=8, worker_init_fn=_worker_init_fn_)
        valid_dataset_5 = ChestXRays(csv_file="../data/train/FL/sim3/valid/df_valid_5.csv", root_dir="../data/CheXpert/", train=False, scale_percent=sc, num_samples=num_samples)
        validloader_5 = torch.utils.data.DataLoader(valid_dataset_5, batch_size=bs, shuffle=False, num_workers=8)
        test_dataset = ChestXRays(csv_file="../data/test/df_test.csv", root_dir="../data/CheXpert/", train=False, scale_percent=sc, num_samples=num_samples)
        testloader = torch.utils.data.DataLoader(test_dataset, batch_size=bs, shuffle=False, num_workers=8)

        train_datasets = [train_dataset_0, train_dataset_1, train_dataset_2, train_dataset_3, train_dataset_4, train_dataset_5]
        trainloaders = [trainloader_0, trainloader_1, trainloader_2, trainloader_3, trainloader_4, trainloader_5]
        validloaders = [validloader_0, validloader_1, validloader_2, validloader_3, validloader_4, validloader_5]
    
    return train_datasets, test_dataset, trainloaders, validloaders, testloader
...
def train(model, trainloader, validloader, epochs, device, cid, k, fed_rounds):
    ...
    for epoch in range(epochs):
        ...
        for i, data in enumerate(trainloader):
            print('Round {}/{}. Training Client {}. Epoch {}/{}: Batch {}/{}.'.format(k, fed_rounds, cid, epoch+1, epochs, i+1, len(trainloader)), end='\r')
            # warm up
            optimizer.zero_grad()
            input, labels = data
        ...
        loss_avg_val, accuracy_val = valid(model, validloader, trainloader, i, cid, epoch, epochs, k, fed_rounds, device)

        params = model.state_dict()

    return params, loss_avg_val, accuracy_val
...
def valid(model, validloader, trainloader, i, cid, epoch, epochs, k, fed_rounds, device):
    ...
    with torch.no_grad():
        ...
        for j, data in enumerate(validloader, 0):
            print('Round {}/{}. Training Client {}. Epoch {}/{}: Batch {}/{}. Validation - Batch {}/{}.'.format(k, fed_rounds, cid, epoch+1, epochs, i+1, len(trainloader), j+1, len(validloader)), end='\r')
    ...
    # end of validation
    return np.mean(list(eval_metrics_val['loss'].values())), eval_metrics_val['accuracy']
...
def test(model, testloader, test_dataset, writer, output_dir, model_str, gradcam, device):
    print('START TESTING')
    ...
    if gradcam:
        ...
        for image_idx in range(len(inputs_test_list)):
            ...
            image = inputs_test_list[image_idx].unsqueeze(dim=0)
            labels = labels_test_list[image_idx] 
            ...
            for label_idx in range(len(labels)): 
                if labels[label_idx] == 1:
                    ...
                    counterheatmap_vis = cv2.applyColorMap(np.uint8(counterheatmap_vis), cv2.COLORMAP_JET)              # COLORMAP_JET has 64 colors: dark blue (0,0,144) and dark red (128,0,0) at edges
                    ...
                    # plot: original image, heatmap, combination, counterheatmap, transformed heatmap
